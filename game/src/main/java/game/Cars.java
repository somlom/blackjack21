...
public class Cars {
  ...
  private Image enemyimg = new Image("red.png");
  private Image enemypassed = new Image("yellow.png");
  private Image temp = new Image("red.png");
  private Image collision = new Image("white.png");
